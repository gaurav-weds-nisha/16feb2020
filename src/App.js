...
function App() {
  ...
  useEffect(() => {
    const countDownDate = new Date("Feb 16, 2020").getTime();
    ...
    <Fragment>
        ...
        <div className="container">
          <div className="media-container-row">
            <div className="title col-12 col-md-8">
              <h2 className="align-center pb-3 mbr-fonts-style display-1">Gaurav</h2>
              <h3 className="align-center mbr-light mbr-fonts-style display-7">
                S/o Smt. Neelam & Sh. Rajesh Kumar
              </h3>
            </div>
          </div>
        </div>
      ...
      <section className="mbr-section content4 cid-qIifwA2R02" id="content4-4" style={{ paddingTop: "50px", paddingBottom: "80px" }}>
        <div className="container">
          <div className="media-container-row">
            <div className="title col-12 col-md-8">
              <h2 className="align-center pb-3 mbr-fonts-style display-1">Nisha</h2>
              <h3 className="align-center mbr-light mbr-fonts-style display-7">
                D/o Smt. Mamta & Sh. Anil Ghai </h3>
            </div>
          </div>
        </div>
      </section>
